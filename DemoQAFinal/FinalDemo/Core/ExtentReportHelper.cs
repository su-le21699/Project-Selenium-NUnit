...
namespace FinalDemo.Core
{
    public class ExtentReportHelper
    {
            ...
            try
            {
                switch (status)
                {
                    case TestStatus.Failed:
                        ...
                        var mediaEntity = CaptureScreenShotAndAttachToExtendReport(driver, fileLocation);
        ...
        public static MediaEntityModelProvider CaptureScreenShotAndAttachToExtendReport(IWebDriver driver, String path)
        {
